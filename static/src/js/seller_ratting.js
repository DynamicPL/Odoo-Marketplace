...
// var  = core.;
    $(document).ready(function() {
        ...
        $('#mp-load-morebtn').on('click',function (e)
        {
            ...
            jsonrpc("/seller/load/review/count", 
            {
                'seller_id':seller_id,
                'offset': offset,
                'limit': limit,
